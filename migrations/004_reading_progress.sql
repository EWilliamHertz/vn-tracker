...
-- Run this in Supabase SQL Editor AFTER 003_community_schema.sql
-- ============================================================
...
CREATE TABLE IF NOT EXISTS reading_progress (
  ...
  manga_id BIGINT NOT NULL REFERENCES manga_series(id) ON DELETE CASCADE,
...
-- Creator applications (for /creator-signup)
...
-- Users can view their own progress (and others can see it for profiles)
...
-- RLS for creator_applications (anyone can insert, only admins read)
...
-- Enable realtime on reading_progress for live updates
